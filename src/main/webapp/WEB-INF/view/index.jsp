...
<body>
	...
	<div class="content">
		<div class="container">
			...
			<div class="info">
				전체 게시글 수 : ${post_count} <br /> 전체 댓글 수 : 0
				...
				<table class="table table-striped custom-table">
					...
					<tbody>
						<c:forEach var="post" items="${list}">
							<tr>
								<td>${post.id}</td>
								<td class="pl-0"><a href="detail" class="name">${post.title}(${post.cmt_count})</a></td>
								<td>${post.writer}</td>
						...
						<tr>
							<td>2</td>
							<td class="pl-0"><a href="detail" class="name">Web
									Designer dsklfjklsdjalksjdflksj lvkmdfalknmlgv(0)</a></td>
							<td>James Yates</td>
							<td>2022-08-06</td>
							<td>100</td>
							<td>10</td>
						...
						<tr>
							<td>1</td>
							<td class="pl-0"><a href="detail" class="name">Graphic
									Designer dsklfjklsdjalksjdflksj lvkmdfalknmlgv(0)</a></td>
							<td>Float</td>
							<td>2022-08-01</td>
							<td>23</td>
